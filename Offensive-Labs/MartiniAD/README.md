...
**`Pwn3d!`** — `athena.t0` used the identical password. A Domain-Admin-tier account and a service account sharing one credential is a catastrophic failure, and it handed over the domain.
